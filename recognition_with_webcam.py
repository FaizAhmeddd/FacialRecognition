...
# Main function (for example, video capture loop)
async def FaceRecognitionWebcam(webcam_stream, community_id, camera_id):
...
if __name__ == "__main__":
    try:
        ...
        recognized_ids, unknown_visitors = asyncio.run(FaceRecognitionWebcam(0))
